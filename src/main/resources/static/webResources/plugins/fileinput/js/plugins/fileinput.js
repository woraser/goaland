...
(function ($) {
    ...
    FileInput.prototype = {
        ...
        renderRemove: function () {
            ...
            return '<div class="' + css + '"' + status + '>' + self.removeIcon + self.removeLabel + '</div>';
        },
        renderCancel: function () {
            ...
            return '<div class="hide ' + css + '">' + self.cancelIcon + self.cancelLabel + '</div>';
        },
        renderUpload: function () {
            ...
            if (!self.isUploadable || self.isDisabled) {
                content = '<div class="' + css + '"' + status + '>' + self.uploadIcon + self.uploadLabel + '</div>';
            } else {
